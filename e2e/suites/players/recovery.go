...
func crashRecovery(ctx context.Context, t *engine.Scope) error {
	...
	if err = fixtures.CreateFile(ctx, client, fixtures.ServerOf(t.Env).ID, "/usercache.json", `[{"name":"RecoveredFixture","uuid":"123e4567-e89b-42d3-a456-426614174000"}]`); err != nil {
		return err
	}
