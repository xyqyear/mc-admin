...
def generate_yaml(server_name: str, game_port: int = 25565, rcon_port: int = 25575) -> str:
...
class TestYAMLValidation:
    ...
    def test_create_server_invalid_yaml_missing_game_port(self, test_client_with_temp_path):
    ...
    def test_create_server_invalid_yaml_missing_rcon_port(self, test_client_with_temp_path):
...
class TestAuthenticationAuthorization:
    ...
    def test_create_server_unauthorized(self, test_client_with_temp_path):
        ...
        response = test_client_with_temp_path.post(
            "/api/servers/unauthorized-server",
