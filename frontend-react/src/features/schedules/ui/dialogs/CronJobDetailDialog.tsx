...
import { useCronJob, useCronJobExecutions, useCronJobNextRunTime, useRegisteredCronJobs } from '@/features/schedules/queries'
import { CronJobStatusTag, ExecutionStatusTag, NextRunTimeDisplay, CronExpressionDisplay } from '@/features/schedules/ui/index'
import { formatDateTime } from '@/shared/utils/formatUtils'
import type { CronJobExecution } from '@/features/schedules/contracts';
                  ...
                  <>
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          ...
                          <div>
                            ...
                            <span className="ml-2">
                              ...
                              <CronRegistrationStatus status={jobDetail.registration_status} error={jobDetail.registration_error} />
                            </span>
                          </div>
                          <div>
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-3">
                        ...
                        {jobDetail.status.toLowerCase() === 'active' && (!jobDetail.registration_status || jobDetail.registration_status === 'registered') && nextRunTime && (
                          <div>
